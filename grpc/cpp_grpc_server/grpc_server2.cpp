...
public:
    ...
    void beginRequest(_Service* svc, ServerCompletionQueue* cq, void(_Service::*f)(::grpc::ServerContext* context, _Request* request, ::grpc::ServerAsyncResponseWriter<_Response>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void* tag)) {
...
public:
    SayHelloRequest(Greeter::AsyncService* service, ServerCompletionQueue* cq)
        ...
        beginRequest(service, cq, &Greeter::AsyncService::RequestSayHello);
    }
    ...
    void onClone() override {
        new SayHelloRequest(service_, cq_);
    }
};
...
public:
    ...
    void Run() {
        ...
        new SayHelloRequest(this, cq_.get());
        HandleRpcs();
    }
